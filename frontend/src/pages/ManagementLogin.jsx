...
const ManagementLogin = () => {
    ...
    return (
        <div className="login-page">
            <div className="login-card" style={{ borderTop: '4px solid var(--secondary)' }}>
                <div className="login-header">
                    ...
                    <h1 style={{ color: 'var(--secondary)' }}>Admin / HOD Portal</h1>
                </div>
                ...
                {stage === 'email' && (
                    <form onSubmit={handleCheckEmail}>
                        ...
                        <button type="submit" className="btn btn-primary btn-block" style={{ background: 'var(--secondary)' }} disabled={isSubmitting}>
                ...
                {stage === 'otp' && (
                    <form onSubmit={handleVerifyOTP}>
                        ...
                        <button type="submit" className="btn btn-primary btn-block" style={{ background: 'var(--secondary)' }}>
                            Verify OTP
                        </button>
